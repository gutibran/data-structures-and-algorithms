/***********************************************************************
 * File: 9-palindrome-number.c
 * Description: My solution to https://leetcode.com/problems/palindrome-number/description/
 * Author: Brandon Gutierrez (bran09123@gmail.com)
 * Purpose:
 * Usage:
***********************************************************************/
